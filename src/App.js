 ...
 */    this.setState({ databaseList })
    ...
    console.log("firstLineValues:", firstLineValues)
...
/*     console.log(this.state._orderId)
 */    this.loadBlockchainData()
  }
  ...
  addRow(OrderId, BatchNumber, PrevOrderId, ShipmentDate, WorkPerformed, Article, ReceiverId) {
    this.setState({ loading: true })
    console.log('PrevOrderId ohne []', PrevOrderId)
    /* var prefix = '[';
    var suffix = ']';
    PrevOrderId = prefix + PrevOrderId + suffix; */
    console.log('PrevOrderId mit []', PrevOrderId)
    PrevOrderId = PrevOrderId.split(",");
    console.log('PrevOrderId nach .split', PrevOrderId)
  ...
  render() {
    return (
      <div id="App">
        {/* <nav id="navbar"><a> || Your Account @{this.state.network} Network: {this.state.account}</a></nav> */}
        <section id="navbar-container">
          <nav id="navbar">
            <Stack direction="horizontal" gap={3}>
              <div className=""><h1>Supply-Chain Demonstrator</h1></div>
              <div className="ms-auto">Your Account @{this.state.network} Network:</div>
              <div className="">{this.state.account}</div>
            </Stack>
          </nav>
        </section>
        <div>
          <Accordion defaultActiveKey="0">
                  ...
                  <Row>
                    <Col sm={2}>
                      <Nav variant="pills" className="flex-column">
                        <Nav.Item>
                          <Nav.Link eventKey="first">Grundlagen</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="second">View Dataset</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="third">Add Dataset</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="fourth">Change Dataset</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                          <Nav.Link eventKey="fifth">Admin-Area</Nav.Link>
                        </Nav.Item>
                      </Nav>
                    </Col>
                    <Col sm={9}>
            ...
            <Accordion.Item eventKey="4">
              <Accordion.Header _disabled={{ bg: 'red', color: 'white' }}>Admin-Area</Accordion.Header>
              <Accordion.Body>
                {this.state.loading
                  ? <Spinner animation="border" role="status"><span className="visually-hidden">Loading...</span></Spinner>
